...
TEST_CASE("FarMemoryContainer::Blocked::BTreeMap::batch_vEB")
{
    using Alloc = FarMalloc::CollectiveAllocator<std::pair<const size_t, size_t>, PageSize>;
    Alloc alloc{PageSize * 7};
    FarMemoryContainer::Blocked::BTreeMap<size_t, size_t, 2, std::less<size_t>, Alloc> map{alloc};
