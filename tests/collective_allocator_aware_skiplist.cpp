...
TEST_CASE("FarMemoryContainer::Blocked::SkiplistMap")
{
    using Alloc = FarMalloc::CollectiveAllocator<std::pair<const size_t, size_t>, PageSize>;
    Alloc alloc{PageSize * 256};
    FarMemoryContainer::Blocked::SkiplistMap<size_t, size_t, std::less<size_t>, Alloc> map{alloc};
